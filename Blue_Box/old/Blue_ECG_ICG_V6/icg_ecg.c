...
int mux_inputs_1[] = {EXC_R, RET_GND, SNS_AP, SNS_AN};
int mux_outputs_1[] = {OUT_1, OUT_2, OUT_3, OUT_4}; // Outputs are in range 1-32
int num_pairs_1 = 4; // Enter the number of pairs
...
// Globals
const uint32_t sr_initial_val = 0b10110010001001111111111111111101;
...
void initEPWM_ADC(void)
{
    ...
    EPWM_setCounterCompareValue(EPWM_FOR_ADC_BASE , EPWM_COUNTER_COMPARE_B, 99);
