...
void init_i2c()
{
    ...
    I2C_initMaster(I2CB_BASE, DEVICE_SYSCLK_FREQ, 40000, I2C_DUTYCYCLE_50);
...
void setup(){
    ...
    write_register(MAX30105_FIFOCONFIG, MAX30105_SAMPLEAVG_2 | MAX30105_ROLLOVER_ENABLE);
    ...
    write_register(MAX30105_PARTICLECONFIG, MAX30105_ADCRANGE_2048 | MAX30105_SAMPLERATE_800 | MAX30105_PULSEWIDTH_411);
    //write_register(MAX30105_LED1_PULSEAMP, 0x7F);
    write_register(MAX30105_LED3_PULSEAMP, 0xAF);
