...
// Extern declarations
extern const unsigned int freqValues[];   // const must be included
extern unsigned int activeFreqs[];      // size optional, but helps readability
...
typedef struct {
    long ExcitationI;  // Accumulate excitation signal in-phase component
    long ExcitationQ;  // Accumulate excitation signal quadrature component
    long Response1I;   // Accumulate response 1 in-phase component
    long Response1Q;   // Accumulate response 1 quadrature component
    long Response2I;   // Accumulate response 2 in-phase component
    long Response2Q;   // Accumulate response 2 quadrature component
    int RefSigSin[BUFLEN];
    int RefSigCos[BUFLEN];
} SignalsStruct;
