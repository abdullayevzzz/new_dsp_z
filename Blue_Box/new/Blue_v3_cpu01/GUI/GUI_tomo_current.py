...
class FrequencyController:
    def __init__(self, def_feq):
        self.dict = {'4 kHz': 0, '7 kHz': 1, '10 kHz': 2, '20 kHz': 3, '40 kHz': 4, '70 kHz': 5, '100 kHz': 6, '200 kHz': 7,
                     '400 kHz': 8, '800 kHz': 9}
        self.anti_dict = {0: '4 kHz', 1: '7 kHz', 2: '10 kHz', 3: '20 kHz', 4: '40 kHz', 5: '70 kHz', 6: '100 kHz',
                          7: '200 kHz', 8: '400 kHz', 9: '800 kHz'}
...
def create_common_buttons():
    ...
    radio_freq = RadioButtons(button_axs[-1],
                              ('4 kHz', '7 kHz', '10 kHz', '20 kHz', '40 kHz', '70 kHz', '100 kHz', '200 kHz',
                               '400 kHz', '800 kHz'), active=4)
