...
void pack (uint8_t* data, uint8_t packetNumber, int32_t  *accumA1I, int32_t  *accumA1Q, int32_t  *accumB1I, int32_t  *accumB1Q,
    ...
    if (*mode == 'd') {
        data[8] = (uint32_t)(*accumA1I >> 16) & 0xFF; //send only 16 MSB
        data[9] = (uint32_t)(*accumA1I >> 24) & 0xFF;

        data[10] = (uint32_t)(*accumA1Q >> 16) & 0xFF;
        data[11] = (uint32_t)(*accumA1Q >> 24) & 0xFF;

        data[12] = (uint32_t)(*accumB1I >> 16) & 0xFF;
        data[13] = (uint32_t)(*accumB1I >> 24) & 0xFF;

        data[14] = (uint32_t)(*accumB1Q >> 16) & 0xFF;
        data[15] = (uint32_t)(*accumB1Q >> 24) & 0xFF;

        data[16] = (uint32_t)(*accumC1I >> 16) & 0xFF;
        data[17] = (uint32_t)(*accumC1I >> 24) & 0xFF;

        data[18] = (uint32_t)(*accumC1Q >> 16) & 0xFF;
        data[19] = (uint32_t)(*accumC1Q >> 24) & 0xFF;
    }
