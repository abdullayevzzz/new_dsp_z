...
void pack (uint8_t* data, uint16_t *packetNumber, int32_t  *accumA1I, int32_t  *accumA1Q, int32_t  *accumB1I, int32_t  *accumB1Q, volatile  uint32_t  *accumC, uint32_t *ppg_result, char *mode) {
...
*/
    ...
    data[2] = (*ppg_result) & 0xFF; //PPG data
    data[3] = (*ppg_result >> 8) & 0xFF;
